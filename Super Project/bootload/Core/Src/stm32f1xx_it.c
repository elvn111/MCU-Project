...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN TD */
extern uint8_t usart_data[2][1024];
extern uint8_t usart_data1[128];
extern uint8_t usart_reflag;
extern uint8_t usart_reflag1;
extern uint8_t FLASH0_Write_Flag;
extern uint8_t FLASH1_Write_Flag;
...
void USART2_IRQHandler(void)
{
  ...
  //   usart_data[0][0]=temp;
  //   HAL_UART_Receive_DMA(&huart2,&usart_data[0][1],2047);
